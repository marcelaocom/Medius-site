...
// ==========================================
// C.O.R.E INTERCEPTOR MESTRE (BLINDADO CONTRA CRASH)
// ==========================================
if (!window._originalMudarSecaoCliente) {
    window._originalMudarSecaoCliente = window.mudarSecaoCliente;
}

window.mudarSecaoCliente = function(secao) {
    // Mantém a troca de tela original do HTML funcionando sem travar
    if (typeof window._originalMudarSecaoCliente === 'function') {
        window._originalMudarSecaoCliente(secao); 
    }
