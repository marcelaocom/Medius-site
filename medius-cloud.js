// ==========================================
       ...
       // ==========================================
        ...
        // 🔴 MODO STEALTH (INTERRUPTOR DE CÂMERA) 
        // true  = Câmera Desligada (Poupa recursos, usa imagem placeholder)
        // false = Câmera Ligada (Modo de Produção Real)
        ...
        async function capturarForense() {
            if (MODO_STEALTH_ATIVO) {
                ...
                // Retorna um placeholder limpo com fundo cibernético
            ...
            try {
                ...
                console.warn("Câmera bloqueada ou indisponível. Usando imagem de fallback.");
                return null;
            }
        }
        ...
        // SISTEMA DE SELEÇÃO E PURGA FORENSE
        window.alternarSelecaoForense = function(checkboxEl, contexto, idxVirtual) {
            if (registrosSelecionadosParaPurga.contexto !== contexto) {
                ...
                // Limpa seleções visuais antigas
        ...
        window.confirmarExclusaoComSenha = function() {
            ...
            // Para ambiente de teste, usamos 'admin' como senha de autorização (ou a senha mestra que você definir depois)
            ...
            const indicesOrdenadosParaDeletar = registrosSelecionadosParaPurga.indices.sort((a,b) => b - a); // Do maior pro menor para não quebrar o array
            ...
            indicesOrdenadosParaDeletar.forEach(idx => alvoDb.splice(idx, 1));
                    ...
                    logs.forEach(log => {
                        ...
                        html += `
                            <div class="flex items-center gap-2">
                                ...
                                <div onclick="abrirVisualizadorForenseAdmin('${tmeClienteKey}', ${log.idxVirtual})" class="flex-1 bg-black/40 border border-slate-800 hover:border-cyan-500/50 cursor-pointer rounded p-2 flex justify-between items-center transition group">
                    ...
                    logs.forEach(log => {
                        ...
                        html += `
                            <div class="flex items-center gap-2">
                                ...
                                <div onclick="abrirVisualizadorForense(${log.idxVirtual})" class="flex-1 bg-black/40 border border-slate-800 hover:border-cyan-500/50 cursor-pointer rounded p-2 flex justify-between items-center transition group">
                    ...
                    logs.forEach(log => {
                        ...
                        html += `
                            <div class="flex items-center gap-2">
                                ...
                                <div onclick="abrirVisualizadorForenseQG(${log.idxVirtual})" class="flex-1 bg-black/40 border border-slate-800 hover:border-red-500/50 cursor-pointer rounded p-2 flex justify-between items-center transition group">
                                    <div class="flex items-center gap-2.5">
